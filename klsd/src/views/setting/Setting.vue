<!-- <template>
  <div class="setting">
    ...
    <el-tabs tab-position="left">
      <el-tab-pane label="Person Information" class="content">
        <Personal-data></Personal-data>
      </el-tab-pane>
      <el-tab-pane label="Reset password" class="content">
        <Password></Password>
      </el-tab-pane>
      <el-tab-pane label="Account and Security" class="content">
        <el-button type="danger" :icon="Delete" @click="cancelAccount">Logout</el-button>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
