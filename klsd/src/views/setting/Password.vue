<!-- <template>
  <el-form ref="passwordForm" label-width="70px" :model="form" :rules="rules">
    ...
    <el-form-item label="New Passwor" prop="newPassword">
    ...
    <el-form-item>
      ...
      <el-button type="primary" @click="confirm()">Confirm modification</el-button>
    </el-form-item>
  </el-form>
</template>
...
export default defineComponent({
  setup() {
    ...
    async function confirm() {
      ...
      const result = (await HttpManager.updateUserPassword({id,name,oldPassword,password})) as ResponseBody;
